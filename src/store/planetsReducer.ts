...
export const planetsFetchRequested = createAction<number>('PLANETS_FETCH_REQUESTED');
export const planetsFetchSucceeded = createAction<PlanetsRequest>('PLANETS_FETCH_SUCCEEDED');
...
export const planetsReducer = createReducer(initialState, (builder) => {
    builder
        ...
        .addCase(planetsFetchSucceeded, (state, action: PayloadAction<PlanetsRequest>) => {
